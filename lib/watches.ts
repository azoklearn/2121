...
export const watches: Watch[] = [
  {
    ...
    brand: "Rolex",
    model: "Submariner",
    reference: { fr: "14060M — 2 lignes", en: "14060M — Two-liner" },
  ...
  },
  {
    ...
    brand: "Breguet",
    model: "Classique",
    reference: { fr: "Or rose — Manufacture", en: "Rose gold — Manufacture" },
  ...
  },
  {
    ...
    model: "Calatrava",
    reference: { fr: "5196 — Or blanc", en: "5196 — White gold" },
    year: { fr: "Contemporain", en: "Contemporary" },
  ...
  },
  {
    ...
    model: "Malachite 18k",
    reference: { fr: "Or jaune — Années 1970", en: "Yellow gold — 1970s" },
  ...
  },
  {
    ...
    brand: "Cartier",
    model: "Tortue",
    reference: { fr: "Or jaune 18k — Alligator vert", en: "18k yellow gold — Green alligator" },
    year: { fr: "Vintage", en: "Vintage" },
    condition: { fr: "Excellent", en: "Excellent" },
    price: "6 800 €",
